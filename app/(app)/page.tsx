...
import { faUserGroup, faStar, faMapMarkerAlt, faArrowsRotate } from "@fortawesome/free-solid-svg-icons";
...
export default function FeedPage() {
  ...
  const handleRefresh = useCallback(async () => {
    // Convex is already real-time; a brief pause is enough visual feedback
  ...
  return (
    <div className="relative">
      ...
      <div
        key={refreshKey}
        className="max-w-2xl mx-auto w-full px-5 py-6"
        style={{
